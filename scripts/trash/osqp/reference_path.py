    ...
    def _compute_width(self, max_width):
        ...
        for wp_id, wp in enumerate(self.waypoints):
            ...
            for i, dir in enumerate(['left', 'right']):
                ...
                # print("max_width: ", max_width, "t_x: ", t_x, "t_y: ", t_y, "wp_id: ", wp_id, "dir: ", dir)
            ...
            for cell in path:
                ...
                if self.map.data[t_y, t_x] == 0:
                    ...
                    if cell_dist < min_width:
                        min_width = cell_dist
                        min_cell = (c_x, c_y)
        # print("min_width: ", min_width, "min_cell: ", min_cell)
...
if __name__ == '__main__':
    ...
    if path == 'Sim_Track':
        ...
        # Load map file
        map = Map(file_path='maps/white_map.png', origin=[-1, -2], resolution=0.015) #resolution in m/pixel
        print("size: ", map.data.shape)
