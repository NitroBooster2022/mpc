...
class Draw_MPC_tracking(object):
    def __init__(self, u, robot_states, ref_states, init_state, 
    ...
    def animation_loop(self, indx):
        ...
        # print("haha", 'x:' + str(round(self.robot_states[indx,0], 2)) + ' y:' + str(round(self.robot_states[indx,1], 2)) + ' yaw:' + str(round(self.robot_states[indx,2], 2)))
        self.ax.set_title(str(indx)+ ' v:' + str(round(self.u[indx][0], 2)) + ' steer:' + str(round(self.u[indx][1], 2)) + ' yaw:' + str(round(self.robot_states[indx,2], 2)))
        # self.ax.set_title(' yaw:' + str(round(self.robot_states[indx,2], 2)))
...
class Draw_MPC_point_stabilization_v1(object):
    def __init__(self, robot_states: list, init_state: np.array, target_state: np.array, rob_diam=0.3,
        ...
        self.fig = plt.figure()
        self.ax = plt.axes(xlim=(-0.8, 15), ylim=(-0.8, 15.))
